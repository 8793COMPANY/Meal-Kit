...
class AccessTermsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(title!!.equals("쇼핑몰 이용약관")){
            binding.contents.setText("제1조(목적)\n" +
                    "\n" +
                    "표준약관 제10023호\n" +
                    "\n" +
            ...
            binding.refundArea.setText("1. 개인 단순변심에 의한 반품 및 환불은 불가능합니다. (ex : 맛이없다, 입맛에 맞지 않는다, 예전에 사먹었을 때와 맛이 다르다, 가격대비 양이 적다 등)\n" +
                    "\n" +
            ...
            binding.contents.setText("이에스에프에프앤비(ESF F&B Co.,Ltd)은(는) 이용자들의 개인정보보호를 매우 중요시하며, 이용자가 회사의 서비스를\n" +
                    ...
                    "\n" +
                    "이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 개인정보 처리방침을 홈페이지 첫 화면에 공개함으로써 이용자들이 언제나 용이하게 보실 수 있도록 조치하고 있습니다.\n" +
                    " \n" +
