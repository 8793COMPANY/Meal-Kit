...
import com.corporation8793.itsofresh.databinding.ActivityAccessTermsBinding

class AccessTermsActivity : AppCompatActivity() {
    lateinit var binding : ActivityAccessTermsBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_access_terms)
        var title = intent.getStringExtra("type")
        binding = DataBindingUtil.setContentView(this, R.layout.activity_access_terms)
        binding.title = title
        ...
        if(title!! == "쇼핑몰 이용약관"){
            binding.contents.text = """
                ...
                이 약관은 이에스에프에프앤비(ESF F&B Co.,Ltd) 회사(전자거래 사업자)가 운영하는 대도김치 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
                ※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」

                제2조(정의)

                ① "몰"이란 이에스에프에프앤비(ESF F&B Co.,Ltd) 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
            ...
            binding.refundArea.text = """
                - 배송소요기간 최대 2일

                - 개인 단순변심에 의한 반품 및 환불은 불가능합니다. (ex : 맛이없다, 입맛에 맞지 않는다, 예전에 사먹었을 때와 맛이 다르다, 가격대비 양이 적다 등)

                - 택배과정에서 발생하는 파손, 오배송, 배송지연(예외 : 제주 및 도서산간지역의 경우 최대 3일정도 소요될 수 있습니다.) 의 경우에는 재발송, 환불, 반품이 가능합니다.

                - 고객의 단순 변심에 의한 반품의 경우 반품배송비가 차감된 금액으로 환불처리 됩니다
            """.trimIndent()
        }
    else{
            binding.contents.text = """
                ...
                이에스에프에프앤비(ESF F&B Co.,Ltd)은(는) 이용자들의 개인정보보호를 매우 중요시하며, 이용자가 회사의 서비스를
                이용함과 동시에 온라인상에서 회사에 제공한 개인정보가 보호 받을 수 있도록 최선을 다하고
                있습니다. 이에 이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 통신비밀보호법, 전기통신사업법, 정보통신망 이용촉진 및 정보보호 등에
                관한 법률 등 정보통신서비스제공자가 준수하여야 할 관련 법규상의 개인정보보호 규정 및
                정보통신부가 제정한 개인정보보호지침을 준수하고 있습니다. 이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 개인정보 처리방침을 통하여
                ...
                이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 개인정보 처리방침을 홈페이지 첫 화면에 공개함으로써 이용자들이 언제나 용이하게 보실수 있도록 조치하고 있습니다.




                회사의 개인정보 처리방침은 정부의 법률 및 지침 변경이나 회사의 내부 방침 변경 등으로 인하여 수시로 변경될 수 있고,
                이에 따른 개인정보 처리방침의 지속적인 개선을 위하여 필요한 절차를 정하고 있습니다.
                그리고 개인정보 처리방침을 개정하는 경우나 개인정보 처리방침 변경될 경우 쇼핑몰의 첫페이지의 개인정보처리방침을 통해 고지하고 있습니다.
                이용자들께서는 사이트 방문 시수시로 확인하시기 바랍니다.




                이에스에프에프앤비(ESF F&B Co.,Ltd)(주)의 개인정보 처리방침은 다음과 같은 내용을 담고 있습니다.
                ...
                이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 이용자들이 회사의 개인정보 처리방침 또는 이용약관의 내용에 대하여 「동의」버튼 또는
                ...
                그러나 이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 회원서비스를 통하여 이용자들에게 맞춤식 서비스를 비롯한 보다 더 향상된 양질의
                서비스를 제공하기 위하여 이용자 개인의 정보를 수집하고 있습니다.




                이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 이용자의 사전 동의 없이는 이용자의 개인 정보를 공개하지 않으며, 수집된 정보는 아래와
                같이 이용하고 있습니다.
                ...
                이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 신규 서비스개발이나 컨텐츠의 확충 시에 기존 이용자들이 회사에 제공한 개인정보를
                바탕으로 개발해야 할 서비스의 우선 순위를 보다 더 효율적으로 정하고, 이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 이용자들이 필요로
                ...
                이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 이용자들이 회원서비스를 이용하기 위해 회원으로 가입하실 때 서비스 제공을 위한 필수적인
                ...
                이용자가 쇼핑몰 회원으로서 회사에 제공하는 서비스를 이용하는 동안 이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 이용자들의 개인정보를
                ...
                보존할 필요가 있는 경우 이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다.
                이 경우 이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 보관하는 정보를 그 보관의 목적으로만 이용하며 보존기간은 아래와 같습니다.
                ...
                이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 귀중한 회원의 개인정보를 안전하게 처리하며, 유출의 방지를 위하여 다음과 같은 방법을
                통하여 개인정보를 파기합니다.
                ...
                이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 이용자들의 개인정보를 "2. 개인정보의 수집목적 및 이용목적"에서 고지한 범위 내에서
                ...
                신고할 수 있고, 이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 이용자들의 신고사항에 대하여 신속하고도 충분한 답변을 해 드릴
                것입니다.




                개인정보 보호책임자 및 담당자의 소속-성명 및 연락처
                ...
                있습니다. 이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 비밀번호에 대해 어떠한 방법으로도 이용자에게 직접적으로 질문하는 경우는
                없으므로 타인에게 비밀번호가 유출되지 않도록 각별히 주의하시기 바랍니다.
                특히 공공장소에서 온라인상에서 접속해 있을 경우에는 더욱 유의하셔야 합니다.
                이에스에프에프앤비(ESF F&B Co.,Ltd)(주)는 개인정보에 대한 의견수렴 및 불만처리를 담당하는 개인정보 보호책임자 및 담당자를
                ...
                이에스에프에프앤비(ESF F&B Co.,Ltd)는 온라인 환경에서 만 14세 미만 어린이의 개인정보를 보호하는 것 역시 중요한 일이라고 생각하고 있습니다.

                이에스에프에프앤비(ESF F&B Co.,Ltd)는 만 14세 미만의 어린이들은 법정대리인의 동의가 없는 한 회원으로 가입할 수 없게 하고 있습니다. 즉, 만 14세 미만의 어린이들은 법정대리인의 동의가 있을 때만 이에스에프에프앤비(ESF F&B Co.,Ltd)에서 회원 자격의 서비스를 받을 수 있습니다.
