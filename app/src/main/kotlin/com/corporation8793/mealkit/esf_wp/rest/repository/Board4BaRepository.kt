...
import com.corporation8793.mealkit.esf_wp.rest.data.PostExcerpt
...
class Board4BaRepository(val basicAuth : String) {
    ...
    fun retrievePostInCategories(per_page : String = "100", page : String = "1", order : String = "desc",
        ...
        val call = RestClient.board4BaService.retrievePostInCategories(per_page, page, order, verifiedCategories)
